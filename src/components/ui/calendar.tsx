...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={clsx(
        "bg-background group/calendar p-3 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-[#fff] dark:[[data-slot=popover-content]_&]:bg-04",
